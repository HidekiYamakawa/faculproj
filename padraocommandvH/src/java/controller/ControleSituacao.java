 ...
 * @author hidek
 */
@WebServlet(name = "ControleSituacao", urlPatterns = {"/ControleSituacao"})
public class ControleSituacao extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String nomedaclasse = "command.situacao." + acao + "SituacaoAction";
